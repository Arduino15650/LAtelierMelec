(function(){
  ...
  const homeItems=[
    ...
    {view:'teaching',icon:'▣',title:'Cours · TD · TP',text:'Créer les cours et ressources pour les élèves.'}
  ];
  ...
  function renderHome(){
    ...
    const classes=[...new Set(activities.map(activity=>activity.className).filter(Boolean))].sort((a,b)=>a.localeCompare(b,'fr',{numeric:true}));
